    ...
    <section class="home-section">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100 c-img img-fluid" id="al-noor" src="{{ asset('public/assets/images/West-Marina/05.origRGB.0000-scaled.jpg') }}"
                        alt="First slide">
                    <div class="carousel-caption">
                        <h1 class="team1 text-white">WEST MARINA</h1>
                        <h1 class="team1 text-white">COTTAGES AND</h1>
                        <h1 class="team1 text-white">VILLAS</h1>
        ...
        <div class="overview mt-5 mb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="font-weight-bold">WEST MARINA COTTAGES AND VILLAS</h5>
                        <p class="al mt-3 mb-3">West Marina Cottages & Villas offering you 5 Marla house in Lahore on easy
                            installments with all residential facilities. West Marina Cottages & Villas is the Premium
                            Residential
                            Block in Al-Noor Orchard. Booking amount is starting from just Rs.600,000 and easy monthly
                            installments
                            start from just of Rs.27,000. 80% of the community is facing park. Signature designed by Mazhar
                            Munir.
                            Green belt on the front and back. Cottages and Villas are a revolution in residential schemes in
                            Lahore
                            West. Villas are of 2 type, Classic & Modern, complete 5 Marla house with master bedroom.
                            Cottages are 5
                            Marla portion with separate entry.
                        </p>
                        <a href="#" class="btn btn-default btn-payment mt-3"><i class="fa fa-map-marker aria-hidden="
                                true"></i>
                            &nbsp; Location</a>
                    ...
                    <div class="col-md-6 text-center">
                        <iframe height="300" id="ifram" src="https://www.youtube.com/embed/ESUQit_xagI"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100"
                                        src="{{ asset('public/assets/images/West-Marina-Catelogs/Al-Jalil-Gardens-SlideShow-04.jpg') }}"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="{{ asset('public/assets/images/West-Marina-Catelogs/Al-Jalil-Gardens-SlideShow-07.jpg') }}"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="{{ asset('public/assets/images/West-Marina-Catelogs/Al-Jalil-Gardens-SlideShow-06.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina-Catelogs/5.jpg') }}" alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina-Catelogs/6.jpg') }}" alt="Third slide">
                                </div>
                            </div>
