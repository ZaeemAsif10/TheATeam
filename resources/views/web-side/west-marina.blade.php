    ...
    <section class="home-section">
        ...
        <div class="overview mt-5 mb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="font-weight-bold">WEST MARINA - AL NOOR ORCHARD</h5>
                        <p class="al mt-3 mb-3">West Marina, the heart of Al Noor Orchard Housing Scheme, is the newest
                            block of the
                            scheme offering 3,5,10 Marla and 1 Kanal lake-facing plots. West Marina is a perfect blend of
                            modernity
                            and serenity that offers a 72-Kanal lake, underground electricity, lush green parks and jogging
                            tracks, a
                            sports complex and gym, and much more. Book your plot in West Marina today.
                        </p>
                    ...
                    <div class="col-md-6 text-center">
                        <iframe height="300" id="ifram" src="https://www.youtube.com/embed/8RY-Z4jROsg"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/02.origRGB.0000-scaled.jpg') }}"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/04.origRGB.0000-scaled.jpg') }}"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/05.origRGB.0000-scaled.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/Al-Noor-SlideShowPic05.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/Al-NoorOrchard-GalleryPic02.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/Al-NoorOrchard-GalleryPic03.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/Al-NoorOrchard-GalleryPic04.jpg') }}"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('public/assets/images/West-Marina/Al-NoorOrchard-GalleryPic07.jpg') }}"
                                        alt="Third slide">
                                </div>
                            </div>
