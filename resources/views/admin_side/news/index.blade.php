...
@section('content')
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                    data-target="#AddNewsModal">Add New</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="AddNewsModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="Add_News_Form" action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary add_news">Save</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            //Edit News
            $('#newsTable').on('click', '.btn_edit_news', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('input[name=news_id]').val(data.id);
                        $('input[name=title]').val(data.title);
                        $('textarea[name=description]').val(data.description);
                        $('#store_image').html(
                            '<img src="{{ asset('storage/app/public/uploads/news/') }}/' +
