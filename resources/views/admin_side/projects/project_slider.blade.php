...
@section('content')
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0 align-items-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Project Slider</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="ms-auto">
                            <div class="btn-group">
                                <a href="{{ url('create-project-slider') }}" class="btn btn-outline-primary">Add New</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table mb-0">
                            ...
                            <tbody id="blogsSliderTable">
                                @foreach ($project_slider as $key => $project)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $project->title }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3 fs-6">
                                                <a href="{{ url('edit-project-slider/'.$project->id) }}"
                                                    class="text-warning btn_edit_project_slider">
                                                    <ion-icon name="pencil-sharp" role="img" class="md hydrated"
                                                        aria-label="pencil sharp"></ion-icon>
                                                </a>
                                                <a href="javascript:;" class="text-danger btn_delete_project_slider"
                                                    data-bs-toggle="tooltip" data="{{ $project->id }}" data-bs-placement="bottom" title=""
    ...
    <script>
        ...
        $('#blogsSliderTable').on('click', '.btn_delete_project_slider', function(e) {
                e.preventDefault();
