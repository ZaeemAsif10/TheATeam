     ...
     <div class="page-content-wrapper">
         ...
         <div class="page-content">
                         ...
                         <div class="ps-3">
                             <nav aria-label="breadcrumb">
                                 <ol class="breadcrumb mb-0 p-0 align-items-center">
                                     ...
                                     <li class="breadcrumb-item active" aria-current="page">Add Project Detail</li>
                                 </ol>
                             </nav>
                         </div>
                         <div class="ms-auto">
                             <div class="btn-group">
                                 <a href="{{ url('project/detail') }}" class="btn btn-outline-primary">Back</a>
                             </div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="row">
                 ...
                 <div class="card">
                     <div class="card-body">
                         <h5>Add Project Detail</h5>
                         <form action="{{ url('store_project_detail') }}" method="POST" enctype="multipart/form-data">
                             @csrf
                             <div class="row">
                                 <div class="col-md-12">
